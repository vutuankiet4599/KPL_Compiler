...
Token* getToken(void) {
  ...
  case CHAR_PLUS: 
    ...
    if(charCodes[currentChar] == CHAR_EQ){
    	readChar();
    	return makeToken(SB_AS_ADD, lineNo, colNo);
	}else{
  ...
  case CHAR_TIMES:
    ...
    if(charCodes[currentChar] == CHAR_EQ){
    	readChar();
    	return makeToken(SB_AS_MUL, lineNo, colNo);
	}else{
...
void printToken(Token *token) {
  ...
  case KW_BREAK: printf(" BREAK"); break;
  case KW_CONTINUE: printf(" CONTINUE"); break;
  ...
  case SB_AS_ADD: printf(" +="); break;
  case SB_AS_MUL: printf(" *="); break;
  }
}
